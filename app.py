...
def analyze(req: AnalyzeRequest):
    ...
    # IMPORTANT: for now assume the URL is a WAV file
    ...
    try:
        ...
        # handle binary or softmax outputs
        if pred.shape[0] == 1:
            score = float(pred[0])
            ...
            label = ["dry", "wet"][idx]  # may need swapping depending on t
